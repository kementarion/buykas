...
- 详细排放明细：[https://kastool.com/](https://kastool.com/)
...
- 2022-05 之前是前通缩期，用的是另一套规则：前两周区块奖励是随机 1–1000 KAS/块，之后恒定 500 KAS/秒。这段时期的排放情况，在左侧浅色柱显示。

- 共识补贴表从 2022年5月5日（UTC）起：440 KAS/秒起步，每月 ×2^(−1/12)、约每年减半，到 2057-10 结束。官方文档把这段的结束日写成 2022-05-08，差的约 3 天是上线不久那次全网停机。

- 前通缩期实际产出可能略高于模型：DAG 并行区块各自都拿满额 500 KAS。模型总产出 28.376B 与官方上限 28.704B 相差 327.79M（1.14%）。
